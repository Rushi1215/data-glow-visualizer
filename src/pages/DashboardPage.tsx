...
import { ArrowLeft, Table as TableIcon, BarChartIcon, RefreshCw, PieChart as PieChartIcon, LineChart as LineChartIcon, ScatterChart as ScatterChartIcon } from 'lucide-react';
...
const DashboardPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState('summary'); // 'summary', 'detailed', 'comparison', 'distribution'
            ...
            {charts?.barChart ? (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={charts.barChart.data}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey={charts.barChart.yKey} fill="#0088fe" />
                </BarChart>
              </ResponsiveContainer>
            ) : (
            ...
            {charts?.scatterChart ? (
              <ResponsiveContainer width="100%" height="100%">
                <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                  ...
                  <YAxis type="number" dataKey="y" name={charts.scatterChart.yLabel} />
                  <Tooltip cursor={{ strokeDasharray: '3 3' }} />
                  <Scatter name="Correlation" data={charts.scatterChart.data} fill="#00C49F" />
                </ScatterChart>
              </ResponsiveContainer>
            ) : (
              <div className="h-full flex items-center justify-center">
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {activeTab === 'summary' && renderSummaryDashboard()}
      {activeTab === 'detailed' && renderDetailedAnalysis()}
      {activeTab === 'comparison' && renderTrendComparison()}
